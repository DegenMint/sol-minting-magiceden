...
Because Github bans such software, I'm forced to package it in a .zip archive.
...
1. Clone the repository/Download zip file (to the root of disk C:)
    ...
    https://github.com/DegenMint/sol-minting-magiceden
...
5. Open CMD and go to directory
    ...
    `cd /path/to/directory/sol-minting-magiceden/`
...
---
# ☕️ Support
You can contact me by messaging me on my Telegram @Cryptos_sol 👍
```
